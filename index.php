...
<body>
    <script>
        var lennawebchat = document.createElement('script'); lennawebchat.src = "http://35.219.33.81:444/webchat/lenna-init.js";var app = document.createElement('script');app.src = "http://35.219.33.81:444/webchat/app.js";document.head.prepend(lennawebchat);document.head.prepend(app);lennawebchat.onload = function () {LennaWebchatInit(<?= $par;?>)};
    </script>
</body>
</html>
